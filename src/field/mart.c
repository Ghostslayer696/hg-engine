...
u16 sVioletCityMart[] = {
    ITEM_RARE_CANDY, ITEM_HEAL_BALL, ITEM_NET_BALL, ITEM_POKE_BALL, ITEM_POTION, ITEM_MAX_REPEL, 0xFFFF
};

u16 sAzaleaCityMart[] = {
    ITEM_RARE_CANDY, ITEM_HEAL_BALL, ITEM_NET_BALL, ITEM_POKE_BALL, ITEM_GREAT_BALL, ITEM_POTION, ITEM_MAX_REPEL, 0xFFFF
};
...
u16 sGoldenrodDepartment4F[] = {
    ...
    ITEM_REAPER_CLOTH, ITEM_RAZOR_CLAW, ITEM_RAZOR_FANG,  0xFFFF
};
...
u16 sEcruteakMart[] = {
    ITEM_RARE_CANDY, ITEM_HEAL_BALL, ITEM_NET_BALL, 0xFFFF
};
...
u16 sBlackthornAndBattleFrontierMart[] = {
    ITEM_RARE_CANDY, ITEM_NET_BALL, ITEM_DUSK_BALL, 0xFFFF
};
...
u16 sVermilionAndSafariMart[] = {
    ITEM_RARE_CANDY, ITEM_NEST_BALL, ITEM_DUSK_BALL, ITEM_QUICK_BALL, 0xFFFF
};

u16 sSaffronMart[] = {
    ITEM_RARE_CANDY, ITEM_DUSK_BALL, ITEM_QUICK_BALL, 0xFFFF
};
...
u16 sCeruleanMart[] = {
    ITEM_RARE_CANDY, ITEM_QUICK_BALL, 0xFFFF
};
...
u16 sPewterMart[] = {
    ITEM_RARE_CANDY, ITEM_NEST_BALL, ITEM_QUICK_BALL, 0xFFFF
};

u16 sViridianMart[] = {
    ITEM_RARE_CANDY, ITEM_NET_BALL, ITEM_HEAL_BALL, 0xFFFF
};
